...
> ⚠️ **동적 스킬 정책 안내**
>
> 이 스킬은 **REST API 설계 원칙**을 제공합니다. 아래의 코드 예시는 **참고용 기본 템플릿**입니다.
> 특정 프레임워크나 버전 적용 시에는 **반드시 웹 검색**으로 최신 API를 확인하세요.
>
> - 원칙: URL 네이밍, HTTP 메서드, 상태 코드 → **정적 참조**
> - 구현 예시: 프레임워크별 코드 → **웹 검색 우선**
