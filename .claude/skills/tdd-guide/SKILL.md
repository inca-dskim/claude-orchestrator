...
> ⚠️ **동적 스킬 정책 안내**
>
> 이 스킬은 **TDD 원칙과 사이클**을 제공합니다. 아래의 테스트 코드 예시는 **참고용 기본 템플릿**입니다.
> 특정 테스트 프레임워크나 버전 적용 시에는 **반드시 웹 검색**으로 최신 API를 확인하세요.
>
> - 원칙: Red-Green-Refactor 사이클 → **정적 참조**
> - 구현 예시: JUnit, pytest, Jest 코드 → **웹 검색 우선**
